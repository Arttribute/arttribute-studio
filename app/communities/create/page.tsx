...
//   const model_data2 = await fetch("https://${process.env.NEXT_PUBLIC_VERCEL_URL}/api/tunedmodels");
...
export default function CreateCollectiion() {
  ...
  useEffect(() => {
    fetch(`https://${process.env.NEXT_PUBLIC_VERCEL_URL}/api/tunedmodels`)
      .then((res) => res.json())
      .then((data) => {
        setModelData(data);
      });
                  ...
                  <div className="rounded-md border border-dashed p-10 pt-6 m-4 ">
                    <Form {...form}>
                      ...
                      >
                                        ...
                                        <p className="text-slate-500">
                                          ...
                                          <ol className="text-sm">
                                            <li className="">
                                              ...
                                              Anyone can join the community and
                                              create
                                            </li>
                                            <li className="">
                                              <span className="font-bold">
                                              ...
                                              creations are still visible to
                                              everyone
                                            </li>
                                          </ol>
                                        </p>
                        ...
                        <FormItem>
                          <FormLabel>Upload Community profile image</FormLabel>
                        ...
                        <FormItem>
                          <FormLabel>
                            Upload Community banner image (1500 x 500 px
                            recommended)
                          </FormLabel>
                          <div className="flex flex-col items-center justify-center p-2 border-2 border-dashed border-gray-300 rounded-lg">
                            <input
