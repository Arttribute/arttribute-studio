  ...
  return (
    <>
      <div className="m-2">
        ...
        <Select>
          <div className="flex ml-3 mt-2  text-sm font-medium">Scheduler</div>
          <SelectTrigger className="m-2">
          ...
          <SelectContent>
            <SelectGroup>
              ...
              <SelectItem value="dpm++2m_karras">dpm++2m_karras</SelectItem>
              <SelectItem value="dpm++sde_karras">dpm++sde_karras</SelectItem>
        ...
        <div className="m-2">
          <div className="flex ml-0 mt-3  text-sm font-medium">Steps</div>
          <div className="flex items-center justify-between">
            <Slider
        ...
        <div className="m-2">
          <div className="flex ml-0 mt-3  text-sm font-medium">CFG scale</div>
          <div className="flex items-center justify-between">
            <Slider
